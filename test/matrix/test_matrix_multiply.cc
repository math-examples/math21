...
namespace math21 {
    ...
    void time_gpu_random_matrix(int TA, int TB, int m, int k, int n) {
        ...
        int i;
        clock_t start = clock(), end;
        PtrR32Wrapper gpu_a = math21_vector_create_from_cpuvector_wrapper(m * k, a, 1);
        PtrR32Wrapper gpu_b = math21_vector_create_from_cpuvector_wrapper(n * k, b, 1);
        PtrR32Wrapper gpu_c = math21_vector_create_from_cpuvector_wrapper(m * n, c, 1);
    ...
    void test_gpu_accuracy(int TA, int TB, int m, int k, int n) {
        ...
        PtrR32Wrapper gpu_a = math21_vector_create_from_cpuvector_wrapper(m * k, a, 1);
        PtrR32Wrapper gpu_b = math21_vector_create_from_cpuvector_wrapper(n * k, b, 1);
        PtrR32Wrapper gpu_c = math21_vector_create_from_cpuvector_wrapper(m * n, c_gpu, 1);
