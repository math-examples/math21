...
MATH21_MAKE_KERNEL_NAME_SUFFIX_2(math21_template_subtensor_like_f_set_or_get_using_mask_in_d3, NumReal, f_addto_like_ptr)(\n\
...
\n\
    ...
    if (x2[ix2] == 1) {\n\
        ...
        if (!isGet) {\n\
            y[iy] = (f_addto_like_ptr)(y[iy], x1[ix1]);\n\
        } else {\n\
            x1[ix1] = (f_addto_like_ptr)(x1[ix1], y[iy]);\n\
        }\n\
    }\n\
}\n\
"; 
...
"; 
std::string generic_01_vector_f_set = "\n\
#include <math21_kernels.h>\n\
\n\
// y = x\n\
MATH21_KERNEL_TEMPLATE_HEADER_2(NumType1, NumType2)\n\
...
"; 
std::string generic_01_set = "\n\
#include <math21_kernels.h>\n\
\n\
// see math21_template_subtensor_like_set_or_get_using_mask_in_d3\n\
MATH21_KERNEL_TEMPLATE_HEADER_1(NumReal)\n\
MATH21_KERNEL_EXPORT void\n\
MATH21_MAKE_KERNEL_NAME_SUFFIX_1(math21_template_tensor_subregion_set_or_get, NumReal)(\n\
...
MATH21_KERNEL_TEMPLATE_HEADER_1(NumReal)\n\
MATH21_KERNEL_EXPORT void\n\
MATH21_MAKE_KERNEL_NAME_SUFFIX_1(math21_template_matrix_set_by_matrix, NumReal)(\n\
        NumN n, NumN d2,\n\
...
MATH21_KERNEL_TEMPLATE_HEADER_1(NumReal)\n\
MATH21_KERNEL_EXPORT void\n\
MATH21_MAKE_KERNEL_NAME_SUFFIX_1(math21_template_tensor_3d_set_by_tensor_3d, NumReal)(\n\
...
MATH21_KERNEL_TEMPLATE_HEADER_1(NumReal)\n\
MATH21_KERNEL_EXPORT void\n\
MATH21_MAKE_KERNEL_NAME_SUFFIX_1(math21_template_vector_set_by_value, NumReal)(\n\
...
"; 
std::string generic_cross_correlation = "\n\
#include <math21_kernels.h>\n\
\n\
/**\n\
(1)\n\
...
std::make_pair("generic_04_f_set.kl",generic_04_f_set),
std::make_pair("generic_01.kl",generic_01),
std::make_pair("generic_01_vector_set.kl",generic_01_vector_set),
std::make_pair("generic_01_vector_f_set.kl",generic_01_vector_f_set),
std::make_pair("generic_01_set.kl",generic_01_set),
std::make_pair("generic_cross_correlation.kl",generic_cross_correlation),
std::make_pair("generic_04_set.kl",generic_04_set),
std::make_pair("generic_03.kl",generic_03),
std::make_pair("generic_03_transpose.kl",generic_03_transpose),
std::make_pair("generic_01_f_set.kl",generic_01_f_set),
