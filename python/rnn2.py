...
def create_f_params(input_size, state_size, output_size,
...
if __name__ == '__main__':
    ...
    init_params = create_f_params(input_size=input_size, state_size=state_size, output_size=output_size,
    ...
    def f_1d_2(x_1d, iter):
        ...
        # exit(0)
        py = get_y_from_rnn_log_likelihood(ppredict, train_inputs)
        out = -math21_python_get_ndarray_from_ad_point(py)[0]
    ...
    def df_1d_2(x_1d, iter):
        ...
        py = get_y_from_rnn_log_likelihood(ppredict, train_inputs)
        pdy = math21_point_ad_grad(px, py)
        out = -math21_python_get_ndarray_from_ad_point(pdy)
    ...
    def callback_my(weights, iter, gradient):
        if iter % 10 == 0:
            print("Iteration", iter, "Train loss:", f_1d_2(weights, 0))
            # print_training_prediction(weights)
    ...
    if not is_my:
        ...
        x_1d = adam(df_1d_2, init_x_1d, step_size=0.1,
                    num_iters=num_iters, callback=callback)
