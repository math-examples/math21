...
namespace math21 {
    namespace ad {
        // see op_sum
        VarAd op_mean::cr_vjp_inner(const SetVar &X, VarAd x, VarAd y, VarAd dy, VariableMap &data) const {
        ...
        void op_mean::fv(const SetVar &X, const SetVar &Y, VariableMap &data) const {
