...
namespace math21 {
    namespace ad {
        VarAd op_exp::df_vjp(const SetVar &X, VarAd x, VarAd y, VariableMap &data) const {
        ...
        void op_exp::df(const SetVar &X, VarAd x, VarAd y, VarAd &dydx, VariableMap &data) const {
            if (X(1) != x) {
        ...
        void op_exp::df_dbr(const SetVar &X, VarAd x, VarAd y, VarAd &dydx, VariableMap &data) const {
            if (X(1) != x) {
                dydx = ad_global_get_constant_0();
                return;
            }
