...
namespace math21 {
    namespace ad {
        VarAd op_axis_swap::cr_vjp_inner(const SetVar &X, VarAd x, VarAd y, VarAd dy, VariableMap &data) const {
        ...
        // X = {x, pos, pos2}
        void op_axis_swap::fv(const SetVar &X, const SetVar &Y, VariableMap &data) const {
