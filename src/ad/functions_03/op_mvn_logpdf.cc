...
namespace math21 {
    namespace ad {
        ...
        // y = f(x) => dy/dx = exp(x-y)
        VarAd op_mvn_logpdf::df_vjp(const SetVar &X, VarAd x, VarAd y, VariableMap &data) const {
        ...
        VarAd op_mvn_logpdf::cr_vjp_inner(const SetVar &X, VarAd x, VarAd y, VarAd dy, VariableMap &data) const {
            NumN pos = math21_operator_container_arg(X, x);
        ...
        VarAd op_mvn_dlogpdf::df_vjp(const SetVar &X, VarAd x, VarAd y, VariableMap &data) const {
