...
void math21_generic_tensor_f_shrink_opencl(NumN fname, NumN n, PtrVoidInWrapper x, PtrVoidWrapper y,
    ...
    if (type == m21_type_NumN) {
        math21_template_tensor_f_shrink_opencl<NumN>(fname, n, x, y,
...
void math21_generic_tensor_f_inner_product_like_bcshrink_opencl(
        ...
        NumN nv, NumN dims_v, PtrNInWrapper dv, NumN type) {
    if (type == m21_type_NumR) {
        math21_template_tensor_f_inner_product_like_bcshrink_opencl<NumR>(
                fname, n, x1, x2, y,
                dims_x1, dx1, dims_x2, dx2,
                dims_x, dx, dims_y, dy, nb, b, nv, dims_v, dv);
    } else if (type == m21_type_NumR32) {
        math21_template_tensor_f_inner_product_like_bcshrink_opencl<NumR32>(
                fname, n, x1, x2, y,
                dims_x1, dx1, dims_x2, dx2,
                dims_x, dx, dims_y, dy, nb, b, nv, dims_v, dv);
    } else if (type == m21_type_NumR64) {
        math21_template_tensor_f_inner_product_like_bcshrink_opencl<NumR64>(
                fname, n, x1, x2, y,
                dims_x1, dx1, dims_x2, dx2,
                dims_x, dx, dims_y, dy, nb, b, nv, dims_v, dv);
    } else {
...
void math21_generic_tensor_f_with_broadcast_in_dn_opencl(NumN fname, NumN n,
    ...
    if (type == m21_type_NumN8) {
        ...
        math21_template_tensor_f_with_broadcast_in_dn_opencl<NumN>(fname, n,
                                                                   x1, x2,
                                                                   y, dims_x1, dx1, dims_x2, dx2,
                                                                   dims_y, dy);
    } else if (type == m21_type_NumR) {
...
void math21_generic_vector_f_add_like_opencl(NumN fname, NumN n,
    ...
    if (type == m21_type_NumN8) {
        ...
        math21_template_vector_f_add_like_opencl<NumN>(fname, n,
                                                       x1, x2,
                                                       y);
    } else if (type == m21_type_NumR) {
