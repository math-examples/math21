...
#include "template_opencl_01_set.h"
...
void math21_generic_tensor_subregion_set_or_get_opencl(NumN n, PtrVoidWrapper x, PtrVoidWrapper y, NumN dims,
    ...
    if (type == m21_type_NumR) {
        math21_template_tensor_subregion_set_or_get_opencl<NumR>(n, x, y, dims, dx, dy, offset, isGet);
    } else if (type == m21_type_NumR32) {
        math21_template_tensor_subregion_set_or_get_opencl<NumR32>(n, x, y, dims, dx, dy, offset, isGet);
    } else if (type == m21_type_NumR64) {
        math21_template_tensor_subregion_set_or_get_opencl<NumR64>(n, x, y, dims, dx, dy, offset, isGet);
    } else {
