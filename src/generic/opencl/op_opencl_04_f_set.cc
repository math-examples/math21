...
#include "template_opencl_04_f_set.h"
...
void math21_generic_subtensor_like_f_set_or_get_using_mask_in_d3_opencl(
        NumN fname,
    ...
    if (type == m21_type_NumN8) {
        math21_template_subtensor_like_f_set_or_get_using_mask_in_d3_opencl<NumN8>(fname,
                                                                                   n, x1, x2, y, map1, map2, map3,
                                                                                   dims_x1, dx1, dims_x2, dx2, dims_y,
                                                                                   dy,
                                                                                   dims_map1, dmap1, dims_map2, dmap2,
                                                                                   dims_map3, dmap3, isGet);
    } else if (type == m21_type_NumR) {
        math21_template_subtensor_like_f_set_or_get_using_mask_in_d3_opencl<NumR>(fname,
                                                                                  n, x1, x2, y, map1, map2, map3,
                                                                                  dims_x1, dx1, dims_x2, dx2, dims_y,
                                                                                  dy,
                                                                                  dims_map1, dmap1, dims_map2, dmap2,
        ...
        math21_template_subtensor_like_f_set_or_get_using_mask_in_d3_opencl<NumR32>(fname,
                                                                                    n, x1, x2, y, map1, map2, map3,
                                                                                    dims_x1, dx1, dims_x2, dx2, dims_y,
                                                                                    dy,
                                                                                    dims_map1, dmap1, dims_map2, dmap2,
        ...
        math21_template_subtensor_like_f_set_or_get_using_mask_in_d3_opencl<NumR64>(fname,
                                                                                    n, x1, x2, y, map1, map2, map3,
                                                                                    dims_x1, dx1, dims_x2, dx2, dims_y,
                                                                                    dy,
                                                                                    dims_map1, dmap1, dims_map2, dmap2,
