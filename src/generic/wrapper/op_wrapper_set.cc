...
void math21_generic_tensor_subregion_set_or_get_wrapper(NumN n, PtrVoidWrapper x, PtrVoidWrapper y, NumN dims,
    ...
    math21_generic_tensor_subregion_set_or_get_cpu(n, x, y, dims, dx, dy, offset, isGet, type);
#elif defined(MATH21_FLAG_USE_CUDA)
    math21_generic_tensor_subregion_set_or_get_cuda(n, x, y, dims, dx, dy, offset, isGet, type);
#elif defined(MATH21_FLAG_USE_OPENCL)
    math21_generic_tensor_subregion_set_or_get_opencl(n, x, y, dims, dx, dy, offset, isGet, type);
#endif
}
...
#elif defined(MATH21_FLAG_USE_CUDA)
    math21_generic_subtensor_like_set_or_get_using_mask_in_d3_cuda(
            n, x1, x2, y, map1, map2, map3,
            dims_x1, dx1, dims_x2, dx2, dims_y, dy,
            dims_map1, dmap1, dims_map2, dmap2, dims_map3, dmap3, isGet, type);
#elif defined(MATH21_FLAG_USE_OPENCL)
    math21_generic_subtensor_like_set_or_get_using_mask_in_d3_opencl(
            n, x1, x2, y, map1, map2, map3,
            dims_x1, dx1, dims_x2, dx2, dims_y, dy,
            dims_map1, dmap1, dims_map2, dmap2, dims_map3, dmap3, isGet, type);
#endif
