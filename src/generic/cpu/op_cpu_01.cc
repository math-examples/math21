...
void math21_generic_tensor_3d_swap_row_in_d2_cpu(
        NumN n, void *x, NumN i, NumN j, NumN d1, NumN d2, NumN d3, NumN type) {
    if (type == m21_type_NumN) {
        math21_template_tensor_3d_swap_row_in_d2_cpu(n, (NumN *) x, i, j, d1, d2, d3);
    } else if (type == m21_type_NumR) {
        math21_template_tensor_3d_swap_row_in_d2_cpu(n, (NumR *) x, i, j, d1, d2, d3);
    } else if (type == m21_type_NumR32) {
        math21_template_tensor_3d_swap_row_in_d2_cpu(n, (NumR32 *) x, i, j, d1, d2, d3);
    } else if (type == m21_type_NumR64) {
        math21_template_tensor_3d_swap_row_in_d2_cpu(n, (NumR64 *) x, i, j, d1, d2, d3);
    } else {
        math21_tool_assert(0);
    }
}
