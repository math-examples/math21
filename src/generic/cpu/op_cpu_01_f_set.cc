...
#include "template_cpu_01_f_set.h"
#include "op_cpu_01_f_set.h"

using namespace math21;

// Do not edit.
// file generated by replacing "_set" in set file to "_f_set".
// by replacing "_cpu(" in set file to "_cpu(NumN fname, ".
// by replacing "_cpu(" in set file to "_cpu(fname, ".
...
void math21_generic_tensor_subregion_f_set_or_get_cpu(NumN fname, NumN n, void *x, void *y, NumN dims,
    ...
    if (type == m21_type_NumR) {
        math21_template_tensor_subregion_f_set_or_get_cpu(fname, n, (NumR *) x, (NumR *) y, dims, dx, dy, offset,
                                                          isGet);
    } else if (type == m21_type_NumR32) {
        math21_template_tensor_subregion_f_set_or_get_cpu(fname, n, (NumR32 *) x, (NumR32 *) y, dims, dx, dy, offset,
                                                          isGet);
    } else if (type == m21_type_NumR64) {
        math21_template_tensor_subregion_f_set_or_get_cpu(fname, n, (NumR64 *) x, (NumR64 *) y, dims, dx, dy, offset,
                                                          isGet);
    } else {
...
void math21_generic_matrix_f_set_by_matrix_cpu(NumN fname, NumN d1, NumN d2,
    ...
    if (type == m21_type_NumR) {
        math21_template_matrix_f_set_by_matrix_cpu(fname, d1, d2,
...
void math21_generic_vector_f_set_by_value_cpu(NumN fname, NumN n, NumR value, void *x, NumN stride_x, NumN type) {
    if (type == m21_type_NumN8) {
        math21_template_vector_f_set_by_value_cpu(fname, n, (NumN8) value, (NumN8 *) x, stride_x);
    } else if (type == m21_type_NumN) {
        math21_template_vector_f_set_by_value_cpu(fname, n, (NumN) value, (NumN *) x, stride_x);
    } else if (type == m21_type_NumR) {
        math21_template_vector_f_set_by_value_cpu(fname, n, (NumR) value, (NumR *) x, stride_x);
    } else if (type == m21_type_NumR32) {
        math21_template_vector_f_set_by_value_cpu(fname, n, (NumR32) value, (NumR32 *) x, stride_x);
    } else if (type == m21_type_NumR64) {
        math21_template_vector_f_set_by_value_cpu(fname, n, (NumR64) value, (NumR64 *) x, stride_x);
    } else {
        math21_tool_assert(0);
    }
}
