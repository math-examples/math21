...
void math21_generic_matrix_trans_reverse_axis_cpu(NumN n, const void *x, void *y,
                                                    NumN nr_x, NumN nc_x, NumB isXAxis, NumN type1, NumN type2) {
    if (type1 == m21_type_NumN8) {
        if (type2 == m21_type_NumN8) {
            math21_template_matrix_trans_reverse_axis_cpu(n, (const NumN8 *) x, (NumN8 *) y, nr_x, nc_x, isXAxis);
        } else if (type2 == m21_type_NumR) {
            math21_template_matrix_trans_reverse_axis_cpu(n, (const NumN8 *) x, (NumR *) y, nr_x, nc_x, isXAxis);
        } else {
            math21_tool_assert(0);
        }
    } else if (type1 == m21_type_NumR) {
        if (type2 == m21_type_NumN8) {
            math21_template_matrix_trans_reverse_axis_cpu(n, (const NumR *) x, (NumN8 *) y, nr_x, nc_x, isXAxis);
        } else if (type2 == m21_type_NumN) {
            math21_template_matrix_trans_reverse_axis_cpu(n, (const NumR *) x, (NumN *) y, nr_x, nc_x, isXAxis);
        } else if (type2 == m21_type_NumR) {
            math21_template_matrix_trans_reverse_axis_cpu(n, (const NumR *) x, (NumR *) y, nr_x, nc_x, isXAxis);
        } else {
            math21_tool_assert(0);
        }
    } else {
