...
#include "template_cpu_04_set.h"
#include "op_cpu_04_set.h"

using namespace math21;

void math21_generic_subtensor_like_set_or_get_using_mask_in_d3_cpu(
    ...
    if (type == m21_type_NumN8) {
        math21_template_subtensor_like_set_or_get_using_mask_in_d3_cpu(
                n, (NumN8 *) x1, x2, (NumN8 *) y, map1, map2, map3,
                dims_x1, dx1, dims_x2, dx2, dims_y, dy,
                dims_map1, dmap1, dims_map2, dmap2, dims_map3, dmap3, isGet);
    } else if (type == m21_type_NumR) {
        math21_template_subtensor_like_set_or_get_using_mask_in_d3_cpu(
                n, (NumR *) x1, x2, (NumR *) y, map1, map2, map3,
                dims_x1, dx1, dims_x2, dx2, dims_y, dy,
                dims_map1, dmap1, dims_map2, dmap2, dims_map3, dmap3, isGet);
    } else if (type == m21_type_NumR32) {
        math21_template_subtensor_like_set_or_get_using_mask_in_d3_cpu(
                n, (NumR32 *) x1, x2, (NumR32 *) y, map1, map2, map3,
                dims_x1, dx1, dims_x2, dx2, dims_y, dy,
                dims_map1, dmap1, dims_map2, dmap2, dims_map3, dmap3, isGet);
    } else if (type == m21_type_NumR64) {
        math21_template_subtensor_like_set_or_get_using_mask_in_d3_cpu(
                n, (NumR64 *) x1, x2, (NumR64 *) y, map1, map2, map3,
                dims_x1, dx1, dims_x2, dx2, dims_y, dy,
                dims_map1, dmap1, dims_map2, dmap2, dims_map3, dmap3, isGet);
    } else {
