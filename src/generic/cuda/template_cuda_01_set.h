...
namespace math21 {
    ...
    template<typename T>
    void math21_template_tensor_subregion_set_or_get_cuda(NumN n, T *x, T *y, NumN dims,
        ...
        math21_cuda_kernel_arg_set_and_run(
                n,
                math21_template_tensor_subregion_set_or_get_cuda_kernel<T>,
    ...
    void math21_template_matrix_set_by_matrix_cuda(NumN d1, NumN d2,
        ...
        math21_cuda_kernel_arg_set_and_run(
                n,
                math21_template_matrix_set_by_matrix_cuda_kernel<T>,
    ...
    void math21_template_tensor_3d_set_by_tensor_3d_cuda(NumN d1, NumN d2, NumN d3,
        ...
        math21_cuda_kernel_arg_set_and_run(
                n,
                math21_template_tensor_3d_set_by_tensor_3d_cuda_kernel<T>,
    ...
    void math21_template_vector_set_by_value_cuda(NumN n, T value, T *x, NumN stride_x) {
        ...
        math21_cuda_kernel_arg_set_and_run(
                n,
                math21_template_vector_set_by_value_cuda_kernel<T>,
                n, value, x, stride_x);
    }
}