...
namespace math21 {
    ...
    void math21_template_tensor_f_shrink_cuda(NumN fname, NumN n, const T *x, T *y,
        ...
        if (f_min_like.ptr) {
            math21_cuda_kernel_arg_set_and_run_overload(
                    n,
                    math21_template_tensor_f_shrink_cuda_kernel<T>,
    ...
    void math21_template_tensor_f_inner_product_like_shrink_cuda(NumN fname, NumN n,
        ...
        math21_cuda_kernel_arg_set_and_run(
                n,
                math21_template_tensor_f_inner_product_like_shrink_cuda_kernel<T>,
                f.ptr, n, x1, x2, y,
    ...
    template<typename T>
    void math21_template_tensor_f_inner_product_like_bcshrink_cuda(NumN fname, NumN n,
                                                                   const T *x1, const T *x2, T *y,
        ...
        math21_cuda_kernel_arg_set_and_run(
                n,
                math21_template_tensor_f_inner_product_like_bcshrink_cuda_kernel<T>,
                f.ptr, n, x1, x2, y,
    ...
    M21_EXPT_DEVICE math21_type_f_add_like math21_device_f_is_less_than_p = &math21_device_f_is_less_than;
    M21_EXPT_DEVICE math21_type_f_add_like math21_device_f_is_not_less_than_p = &math21_device_f_is_not_less_than;
    ...
    void math21_template_tensor_f_with_broadcast_in_dn_cuda(NumN fname, NumN n,
        ...
        if (fname == m21_fname_add) {
            ...
            f.set(&math21_device_f_is_less_than_p);
        } else if (fname == m21_fname_ele_is_not_less_than) {
            f.set(&math21_device_f_is_not_less_than_p);
        ...
        if (fname == m21_fname_set_using_mask) {
            math21_cuda_kernel_arg_set_and_run(
                    n,
                    math21_template_tensor_set_using_mask_in_dn_cuda_kernel<T>,
                    n,
                    x1, x2, y,
                    dims_x1, dx1,
                    dims_x2, dx2,
            ...
            math21_cuda_kernel_arg_set_and_run(
                    n,
                    math21_template_tensor_f_with_broadcast_in_dn_cuda_kernel<T>,
                    f.ptr, n,
                    x1, x2, y,
                    dims_x1, dx1,
                    dims_x2, dx2,
    ...
    void math21_template_vector_f_add_like_cuda(NumN fname, NumN n,
        ...
        if (fname == m21_fname_set_using_mask) {
            math21_cuda_kernel_arg_set_and_run(
                    n,
                    math21_template_vector_set_using_mask_cuda_kernel<T>,
                    n, x1, x2, y);
        } else {
            math21_cuda_kernel_arg_set_and_run(
                    n,
                    math21_template_vector_f_add_like_cuda_kernel<T>,
                    f.ptr, n, x1, x2, y);
        }
    }
    ...
    void math21_template_vector_f_sin_like_cuda(NumN fname, NumN n,
        ...
        math21_cuda_kernel_arg_set_and_run(
                n,
                math21_template_vector_f_sin_like_cuda_kernel<T>,
                f.ptr, n, x, y);
    }
    ...
    void math21_template_vector_f_kx_like_cuda(NumN fname, NumN n, T k,
        ...
        math21_cuda_kernel_arg_set_and_run(
                n,
                math21_template_vector_f_kx_like_cuda_kernel<T>,
                f.ptr, n, k, x, y);
    }
}