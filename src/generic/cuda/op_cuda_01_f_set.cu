...
#include "template_cuda_01_f_set.h"
...
void math21_generic_tensor_subregion_f_set_or_get_cuda(NumN fname, NumN n, void *x, void *y, NumN dims,
                                                      const NumN *dx, const NumN *dy,
                                                      const NumN *offset, NumB isGet, NumN type) {
    if (type == m21_type_NumR) {
        math21_template_tensor_subregion_f_set_or_get_cuda(fname, n, (NumR *) x, (NumR *) y, dims, dx, dy, offset,
                                                          isGet);
    } else if (type == m21_type_NumR32) {
        math21_template_tensor_subregion_f_set_or_get_cuda(fname, n, (NumR32 *) x, (NumR32 *) y, dims, dx, dy, offset,
                                                          isGet);
    } else if (type == m21_type_NumR64) {
        math21_template_tensor_subregion_f_set_or_get_cuda(fname, n, (NumR64 *) x, (NumR64 *) y, dims, dx, dy, offset,
                                                          isGet);
    } else {
...
void math21_generic_matrix_f_set_by_matrix_cuda(NumN fname, NumN d1, NumN d2,
    ...
    if (type == m21_type_NumR) {
        math21_template_matrix_f_set_by_matrix_cuda(fname, d1, d2,
...
void math21_generic_tensor_3d_f_set_by_tensor_3d_cuda(NumN fname, NumN d1, NumN d2, NumN d3,
                                                     ...
                                                     NumN offset_x, NumN offset_y, NumN type) {
    if (type == m21_type_NumR) {
        math21_template_tensor_3d_f_set_by_tensor_3d_cuda(fname, d1, d2, d3,
...
void math21_generic_vector_f_set_by_value_cuda(NumN fname, NumN n, NumR value, void *x, NumN stride_x, NumN type) {
    if (type == m21_type_NumN8) {
        math21_template_vector_f_set_by_value_cuda(fname, n, (NumN8) value, (NumN8 *) x, stride_x);
    } else if (type == m21_type_NumN) {
        math21_template_vector_f_set_by_value_cuda(fname, n, (NumN) value, (NumN *) x, stride_x);
    } else if (type == m21_type_NumR) {
        math21_template_vector_f_set_by_value_cuda(fname, n, (NumR) value, (NumR *) x, stride_x);
    } else if (type == m21_type_NumR32) {
        math21_template_vector_f_set_by_value_cuda(fname, n, (NumR32) value, (NumR32 *) x, stride_x);
    } else if (type == m21_type_NumR64) {
        math21_template_vector_f_set_by_value_cuda(fname, n, (NumR64) value, (NumR64 *) x, stride_x);
    } else {
        math21_tool_assert(0);
    }
}
