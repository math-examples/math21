...
#include "template_cuda_04_set.h"
...
void math21_generic_subtensor_like_set_or_get_using_mask_in_d3_cuda(
    ...
    if (type == m21_type_NumN8) {
        math21_template_subtensor_like_set_or_get_using_mask_in_d3_cuda(
