...
namespace math21 {
    ...
    template<typename T>
    void math21_template_subtensor_like_f_set_or_get_using_mask_in_d3_cuda(
            NumN fname,
            NumN n,
            T *x1,
            const NumN *x2,
        ...
        math21_cuda_kernel_arg_set_and_run(
                n,
                math21_template_subtensor_like_f_set_or_get_using_mask_in_d3_cuda_kernel<T>,
                f.ptr, n, x1, x2, y, map1, map2, map3,
