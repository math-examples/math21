...
namespace math21 {
    ...
    void math21_operator_tensor_set_string(TenN8 &A, NumN n, const NumN8 *s, NumB shallow = 1);

    void math21_operator_tensor_set_string(TenN8 &A, const std::string &s, NumB shallow = 1);
