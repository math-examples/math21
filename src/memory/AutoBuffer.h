...
namespace math21 {
    ...
    struct SpaceParas {
        ...
        PtrN8Wrapper address_wrapper;
        PtrN8Wrapper start_wrapper;
#endif
...
//        SpaceParas paras;
        ...
        NumN _deviceType;
#if !defined(MATH21_FLAG_USE_CPU)
        PtrN8Wrapper space_address_wrapper;
        PtrN8Wrapper space_start_wrapper;
#endif
        ...
        void dataCopyFromGpu(PtrN8InWrapper data);
    ...
    public:
        ...
        PtrVoidWrapper getObjGpu() const;
