...
namespace math21 {
    ...
    public:
        ...
        // OptUpdateType_Adam, OptParasAdam, OptCallbackAdam, OptPrintCallbackAdam
        // OptUpdateType_LevMar, OptParasLevMarq, {FunctionNd, OptCallbackLevMarq, OptCallbackSparseLevMarq}, null
        void set(OptUpdateType type, void *optParas, void *cbCompute, void *cbPrint);

        virtual ~OptAlg();

        NumB run(VecR &x0) const;
    };
}