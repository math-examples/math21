...
void math21_optimization_adam_update_wrapper(PtrR32Wrapper x, PtrR32Wrapper neg_dx, PtrR32Wrapper m,
                                             PtrR32Wrapper v, float beta1, float beta2,
                                             float eps, float decay, float alpha, int x_size, int mini_batch_size,
                                             int t);

void math21_generic_optimization_adam_update_wrapper(
        PtrVoidWrapper x, PtrVoidWrapper neg_dx, PtrVoidWrapper m,
        PtrVoidWrapper v, NumR beta1, NumR beta2,
