...
//        unsigned int logLevel;
    ...
    public:
        // This class can only have this constructor. But why?
        SimpleStreamBuf() {
...
//        }
//
//        SimpleStreamBuf(unsigned int logLevel) {
...
//            android_LogPriority t;
//            if (logLevel > 1)t = ANDROID_LOG_ERROR;
//            else t = ANDROID_LOG_INFO;
