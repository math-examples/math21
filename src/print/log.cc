...
//        }
    ...
    void math21_print(std::ostream &io, TenN *t, const char *s) {
        t->log(io, s);
    }

    void math21_print(std::ostream &io, TenZ *t, const char *s) {
        t->log(io, s);
    }

    void math21_print(std::ostream &io, TenR *t, const char *s) {
        t->log(io, s);
    }

    void math21_print(std::ostream &io, const TenN *t, const char *s) {
        t->log(io, s);
    }

    void math21_print(std::ostream &io, const TenZ *t, const char *s) {
        t->log(io, s);
    }

    void math21_print(std::ostream &io, const TenR *t, const char *s) {
        t->log(io, s);
    }
