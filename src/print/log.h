...
namespace math21 {
    ...
    void math21_print(std::ostream &io, TenN *t, const char *s = 0);

    void math21_print(std::ostream &io, TenZ *t, const char *s = 0);

    void math21_print(std::ostream &io, TenR *t, const char *s = 0);

    void math21_print(std::ostream &io, const TenN *t, const char *s = 0);

    void math21_print(std::ostream &io, const TenZ *t, const char *s = 0);

    void math21_print(std::ostream &io, const TenR *t, const char *s = 0);
...
//    template<typename T>
//    void m21cerr(const T &a) {
//#ifdef MATH21_ANDROID
//        SimpleStreamBuf ssb(2);
//        std::streambuf *backup;
...
//    }
    ...
    template<typename T>
    void m21warndebug(T const &message) {
#ifdef MATH21_DEBUG
        std::cerr << "Warn: " << message << std::endl;
#endif
    }
