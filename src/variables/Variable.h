...
namespace math21 {
    namespace ad {
        ...
        private:
            ...
            TenVar variableMat; // variable matrix, i.e., every element is a variable id pointing to the variable in data.
            TenR v; // when isDense
...
//            Variable(Function *f);
            ...
            const TenVar &getMatVar() const;

            void addx(VarAd x);

            void addX(const SetVar &X0);

            void setX(const SetVar &X0);

            SetVar &getX();

            const SetVar &getX() const;

            void addy(VarAd y);

            void add_cache_y(VarAd y);
...
//            SetVar &getY();
            ...
            const SetVar &getY() const;

            const SetVar &getCacheY() const;
