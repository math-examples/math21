...
void math21_vector_mean_wrapper(PtrR32InWrapper X, int mini_batch_size, int features_size, int in_class_size,
                                PtrR32Wrapper mean) {
#if defined(MATH21_FLAG_USE_CPU)
...
void
math21_vector_kx_with_in_class_wrapper(PtrR32Wrapper x, PtrR32InWrapper k, int mini_batch_size,
                                       int features_size,
                                       int in_class_size) {
#if defined(MATH21_FLAG_USE_CPU)
...
// may deprecate
void math21_vector_assign_by_mask_wrapper(int n, PtrR32Wrapper x, float mask_num, PtrR32InWrapper mask,
                                          float val) {
#if defined(MATH21_FLAG_USE_CPU)
    math21_tool_assert(0);
#elif defined(MATH21_FLAG_USE_CUDA)
...
PtrN8Wrapper math21_vector_getEmpty_N8_wrapper() {
    return (PtrN8Wrapper) math21_vector_getEmpty_wrapper();
}

PtrR32Wrapper math21_vector_getEmpty_R32_wrapper() {
    return (PtrR32Wrapper) math21_vector_getEmpty_wrapper();
}
