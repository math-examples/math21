...
void
math21_vector_mean_fast_opencl(PtrR32InWrapper X, int mini_batch_size, int features_size, int in_class_size,
                               PtrR32Wrapper mean) {
    if (program == NULL) {
...
void math21_vector_mean_opencl(PtrR32InWrapper X, int mini_batch_size, int features_size, int in_class_size,
                               PtrR32Wrapper mean) {
    if (program == NULL) {
        program = math21_opencl_build_program_from_file(kernel_file, "");
    }
...
void math21_vector_feature2d_upsample_opencl(int mini_batch_size, PtrR32Wrapper X, int nch_X, int nr_X, int nc_X,
                                             int stride_X,
                                             int is_upsample, float k, PtrR32Wrapper Y) {
