...
namespace math21 {
    ...
    NumB math21_geometry_convert_to_non_homogeneous(const MatR &xs, MatR &xs2, NumB ignoreBad = 1);
    ...
    NumB math21_geometry_project_homogeneous(const MatR &T, const MatR &xs, MatR &Xs, NumB normalize = 1);

    NumB math21_geometry_project_homogeneous_with_jacobian(const MatR &T, const MatR &xs, MatR &Xs,
                                                           NumB normalize, MatR *pJ, NumN type);

    NumB math21_geometry_project_non_homogeneous(const MatR &T, const MatR &xs, MatR &Xs, NumB ignoreBad = 1);

    NumB math21_geometry_project_non_homogeneous_with_jacobian(const MatR &T, const MatR &xs, MatR &Xs,
    ...
    NumB math21_geometry_cal_projectivity(const MatR &Xs, const MatR &Us, MatR &H, NumB useA0 = 0);
    ...
    namespace detail {
        void math21_geometry_warp_image_using_indexes_cpu(const TenR &A, TenR &B, const TenR &index,
                                                          const Interval2D &I, NumB isInterleaved,
    ...
    // nd affine with non-homogeneous coordinates.
    NumB math21_geometry_cal_affine_non_homogeneous(const MatR &X, const MatR &U, MatR &H, NumN method = 0);
    ...
    NumB math21_geometry_rodrigues(const MatR &x, MatR &y, MatR *pdydx = 0);
