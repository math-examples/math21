...
// It can now use macro in kernels because MATH21_FLAG_NOT_EXTERNAL is defined in them.
#if defined(MATH21_FLAG_DEFINE_NUMR_AS_NUMR32) || (defined(MATH21_FLAG_IS_WIN32) && defined(MATH21_FLAG_USE_OPENCL) && !defined(MATH21_ENABLE_DEVICE_NUMR64_SUPPORT))
