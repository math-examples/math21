...
#define NumN_MAX NumN32_MAX
#define NumZ_MAX NumZ32_MAX
#define NumZ_MIN NumZ32_MIN

#if defined(MATH21_USE_NUMR32)
#define NumR_MAX FLT_MAX
#define NumR_MIN FLT_MIN
#else
#define NumR_MAX DBL_MAX
#define NumR_MIN DBL_MIN
#endif
...
//
    ...
    typedef Seqce<NumN> SeqN;
    typedef Seqce<NumZ> SeqZ;
    typedef Seqce<NumR> SeqR;
    typedef Seqce<std::string> SeqStr;
    typedef Seqce<SeqStr> SeqSeqStr;
//    typedef SeqN Sequence;

    template<typename T>
    struct Set_;

    typedef Set_<NumN> SetN;
    typedef Set_<NumZ> SetZ;
    typedef Set_<NumR> SetR;
    typedef SetN Set;
    ...
    struct Map_;
    typedef Map_<NumN, NumN> MapNN;
    typedef Map_<NumZ, NumZ> MapZZ;
    typedef Map_<NumR, NumR> MapRR;
    typedef MapNN Map;
    ...
    typedef Seqce<TenN> SeqTenN;
    typedef Seqce<TenZ> SeqTenZ;
    typedef Seqce<TenR> SeqTenR;
    ...
    namespace ad {
        struct PointAd;
        using ad_point = PointAd; // Deprecated. To be removed in version 8
    }

    class Uobj;
    using m21object = Uobj; // Deprecated. To be removed in version 8
}