...
struct mlfunction_node {
    ...
    void (*resize)(mlfunction_node *fnode, const mlfunction_net *fnet, int nr_X, int nc_X);
    ...
    void (*mergeTo)(mlfunction_node *fnode, mlfunction_node *fbase);

    void (*scale)(mlfunction_node *fnode, float s);

    void (*pull)(mlfunction_node *fnode, NumB useRolling);

    // f is pushed by fb
    void (*pushBy)(mlfunction_node *fnode, mlfunction_node *fbase, NumB useRolling);

    void (*resetState)(mlfunction_node *fnode, int b);

    void (*loadTheta)(mlfunction_node *fnode, FILE *fp);

    void (*saveTheta)(mlfunction_node *fnode, FILE *fp);

    void (*loadThetaOrderBwsmvFlipped)(mlfunction_node *fnode, FILE *fp, int flipped);

    void (*saveThetaOrderBwsmv)(mlfunction_node *fnode, FILE *fp);
