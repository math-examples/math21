...
void math21_function_activation_vector_opencl(PtrR32Wrapper x, int n, MATH21_FUNCTION_ACTIVATION_TYPE a){
    if (program == NULL) {
...
void math21_function_activation_gradient_vector_opencl(PtrR32InWrapper y, int n, MATH21_FUNCTION_ACTIVATION_TYPE a, PtrR32Wrapper dy){
    if (program == NULL) {
        program = math21_opencl_build_program_from_file(kernel_file, "");
    }
