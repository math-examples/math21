...
void math21_function_activation_vector_wrapper(PtrR32Wrapper x, int n, MATH21_FUNCTION_ACTIVATION_TYPE a)
{
...
void math21_function_activation_gradient_vector_wrapper(PtrR32InWrapper y, int n, MATH21_FUNCTION_ACTIVATION_TYPE a, PtrR32Wrapper dy)
{
#if defined(MATH21_FLAG_USE_CPU)
