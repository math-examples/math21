...
void math21_ml_function_softmax_tree_wrapper(
        PtrR32Wrapper input, int in_class_size, int mini_batch_size,
        int stride, float temp, PtrR32Wrapper output, m21tree hier) {
...
void math21_ml_function_softmax_wrapper(PtrR32Wrapper input, int n, int mini_batch_size, int batch_offset, int groups,
                                        int group_offset, int stride, float temp, PtrR32Wrapper output) {
#if defined(MATH21_FLAG_USE_CPU)
