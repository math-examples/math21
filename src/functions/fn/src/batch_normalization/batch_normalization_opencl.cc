...
void
math21_ml_batchnormalization_backward_mu_fast_opencl(PtrR32InWrapper dX_hat, PtrR32InWrapper variance,
...
void
math21_ml_batchnormalization_backward_sigma_square_fast_opencl(PtrR32InWrapper X,
                                                               PtrR32InWrapper dX_hat,
                                                               PtrR32InWrapper mu,
...
void math21_ml_batchnormalization_backward_input_opencl(PtrR32InWrapper X, PtrR32InWrapper mu, PtrR32InWrapper variance, PtrR32InWrapper dmu, PtrR32InWrapper dvariance, int mini_batch_size,
