...
void math21_ml_function_dropout_forward_opencl(FnDropout *f, mlfunction_node *finput, int is_train) {
    if (!is_train) return;
...
void math21_ml_function_dropout_backward_opencl(FnDropout *f, mlfunction_node *finput) {
