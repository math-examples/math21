...
void math21_ml_function_average_pooling_forward_cpu(FnAveragePooling *f, const mlfunction_node *finput) {
    int b, i, k;
...
void math21_ml_function_average_pooling_backward_cpu(FnAveragePooling *f, mlfunction_node *finput) {
    int b, i, k;
