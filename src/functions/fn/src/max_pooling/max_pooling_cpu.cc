...
void math21_ml_function_max_pooling_forward_cpu(FnMaxPooling *f, const mlfunction_node *finput) {
    int b, i, j, k, m, n;
...
void math21_ml_function_max_pooling_backward_cpu(FnMaxPooling *f, mlfunction_node *finput) {
    int i;
    int h = f->out_h;
    int w = f->out_w;
    int c = f->c;
