...
void math21_ml_function_max_pooling_forward_cuda(FnMaxPooling *f, const mlfunction_node*finput)
{
    int h = f->out_h;
    int w = f->out_w;
    int c = f->c;
...
void math21_ml_function_max_pooling_backward_cuda(FnMaxPooling *f, mlfunction_node*finput)
{
