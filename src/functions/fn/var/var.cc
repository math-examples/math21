...
namespace math21 {
    ...
    void m21variable::setWrapper(PtrR32Wrapper data, NumN d1) {
        clear();
        _data_wrapper = data;
        d.setSize(1);
        d = d1;
    ...
    void m21variable::setWrapper(PtrR32Wrapper data, NumN d1, NumN d2) {
        clear();
        _data_wrapper = data;
        d.setSize(2);
        d = d1, d2;
    ...
    void m21variable::setWrapper(PtrR32Wrapper data, NumN d1, NumN d2, NumN d3) {
        clear();
        _data_wrapper = data;
        d.setSize(3);
        d = d1, d2, d3;
    ...
    void m21variable::setWrapper(PtrR32Wrapper data, NumN d1, NumN d2, NumN d3, NumN d4) {
        clear();
        _data_wrapper = data;
        d.setSize(4);
        d = d1, d2, d3, d4;
    ...
    void m21variable::setWrapper(PtrR32Wrapper data, NumN d1, NumN d2, NumN d3, NumN d4, NumN d5) {
        clear();
        _data_wrapper = data;
        d.setSize(5);
        d = d1, d2, d3, d4, d5;
    ...
    NumB m21variable::getDataWrapper(PtrR32Wrapper &p) const {
        if (isEmpty()) {
            return 0;
        }
    ...
    NumB m21variable::setDataWrapper(PtrR32InWrapper p) {
        if (isEmpty()) {
            return 0;
        }
        if (math21_vector_isEmpty_wrapper(_data_wrapper)) {
