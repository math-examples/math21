...
namespace math21 {
    ...
    public:
        ...
        void setWrapper(PtrR32Wrapper data, NumN d1);

        void setWrapper(PtrR32Wrapper data, NumN d1, NumN d2);

        void setWrapper(PtrR32Wrapper data, NumN d1, NumN d2, NumN d3);

        void setWrapper(PtrR32Wrapper data, NumN d1, NumN d2, NumN d3, NumN d4);

        void setWrapper(PtrR32Wrapper data, NumN d1, NumN d2, NumN d3, NumN d4, NumN d5);
        ...
        NumB getDataWrapper(PtrR32Wrapper &p) const;

        NumB setDataCpu(const NumR32 *p);

        NumB setDataWrapper(PtrR32InWrapper p);
